        ...
        <div class="header">
            <div class="header-wrap">
                <h3 class="logo pull-left">
                    <a href="Stu_Homepage2.jsp"><img src="https://www.layui.com/template/xianyan/demo/res/static/images/logo.png" alt="" class="logo-img"></a>
                        ...
                        try {
                            ...
                            while (rs1.next()) {
                                ...
                                while (rs2.next()) {
                                    ...
                                    out.print("&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;" + "班级：" + rs1.getString(1) + "</h3><br>");
                                    ps4.setString(1, rs2.getString(4));
                                    ps4.setString(2, rs2.getString(1));
                                    rs4 = ps4.executeQuery();
                                    out.print("<div class='item'>");
                                    while (rs4.next()) {
                                        out.print("<div class='item-box  layer-photos-demo1 layer-photos-demo'>资源名称：" + rs4.getString(6));
                                        out.print("&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;" + "资源总浏览次数：" + rs4.getInt(5) + "</div>");
                                        if (rs4.getInt(3) == 0) {
                                            out.print("<div class='comment count'><a href=View_Markdown2.jsp?teaid=" + rs2.getString(4) + "&couid=" + rs2.getString(1) + "&souname=" + rs4.getString(6) + "&souid=" + rs4.getString(4) + "&classid=" + rs1.getString(1) + ">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;查看资源</a></div><br>");
                                        } else if (rs4.getInt(3) == 1) {
                                            out.print("<div class='comment count'><a href=View_PPT.jsp?teaid=" + rs2.getString(4) + "&couid=" + rs2.getString(1) + "&souname=" + rs4.getString(6) + "&souid=" + rs4.getString(4) + "&classid=" + rs1.getString(1) + ">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;查看资源</a></div><br>");
                                        } else {
                                            out.print("<div class='comment count'><a href=View_Video.jsp?teaid=" + rs2.getString(4) + "&couid=" + rs2.getString(1) + "&souname=" + rs4.getString(6) + "&souid=" + rs4.getString(4) + "&classid=" + rs1.getString(1) + ">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;查看资源</a></div><br>");
                                        }
                                    }
                                    out.print("</div>");
                                }
