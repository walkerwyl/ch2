...
layui.define('view', function(exports){
  ...
  ,admin = {
    ...
    ,sendAuthCode: function(options){
      ...
      btn.on('click', function(){
        ...
        $.ajax({
            type : "post",
            url : layui.setter.contextPath+'/user/setEmailCode',
            data:{'email':value},
            async : true,
            cache : false,
            dataType : 'json',
  ...
  var events = admin.events = {
    ...
    //基本资料
    ,baseInfo: function(othis){
    	var cid = othis.data('cid');
        layer.open({
            type: 2
            ,title: '编辑用户'
            ,content: layui.setter.contextPath+'/user/userform?cid='+cid
            ,maxmin: true
            ,area: ['700px', '650px']
            ,btn: ['确定', '取消']
            ,yes: function(index, layero){
              ...
              iframeWindow.layui.form.on('submit('+ submitID +')', function(data){
                ...
                //提交 Ajax 成功后，静态更新表格中的数据
                 $.ajax({
  		            type : "post",
  		            url : layui.setter.contextPath+"/user/edit",
  		            data:data.field,
  		            async : true,
  		            cache : false,
  		            dataType : 'json',
    ...
    ,chgPwd: function(){
        layer.open({
            type: 2
            ,title: '修改密码'
            ,content: layui.setter.contextPath+'/user/toChgPwd'
            ,maxmin: true
            ,area: ['450px', '320px']
            ,btn: ['确定', '取消']
            ,yes: function(index, layero){
              ...
              iframeWindow.layui.form.on('submit('+ submitID +')', function(data){
                ...
                //提交 Ajax 成功后，静态更新表格中的数据
                 $.ajax({
  		            type : "post",
  		            url : layui.setter.contextPath+"/user/chgPwd",
  		            data:data.field,
  		            async : true,
  		            cache : false,
  		            dataType : 'json',
