    ...
    <body style="background-color:rgba(241,241,241,.98)">
        <%
			...
			if(classid != null) {
				...
				target = "calcTime?start=" + start + "&souid=" + souid +"&classid="+ classid;
			}
...
%>
            <form action=<%=target%> method="post">
                <input type="submit" class="class1" value="保存并提交进度" onclick="ShowConfirmClose(false);">
                &emsp;&emsp;&emsp;
                <input type=button  class="class1" value="打开网页异常关闭提示" onclick="ShowConfirmClose(true);">
            </form>
<%		}
%>			
